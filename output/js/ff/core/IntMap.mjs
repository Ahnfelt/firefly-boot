...
const memo_ = ff_core_IntMap.make_();
let f_ = ((_) => {
...
function go_(key_) {
if(ff_core_IntMap.IntMap_has(memo_, key_)) {
return ff_core_IntMap.IntMap_grab(memo_, key_)
} else {
const value_ = body_(f_, key_);
ff_core_IntMap.IntMap_set(memo_, key_, value_);
return value_
}
}
f_ = ((_w1) => {
