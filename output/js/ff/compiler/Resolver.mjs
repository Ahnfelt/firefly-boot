...
const self2_ = (((_c) => {
return ff_compiler_Resolver.Resolver(ff_core_Map.Map_add(self_.variables_, definition_.name_, definition_.name_, ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), _c.variants_, _c.types_, _c.typeLocations_, _c.asyncTypes_, _c.typeParameters_, _c.traits_, _c.state_, _c.hoverAt_)
}))(self_);
{
const _1 = definition_;
{
...
const self2_ = (((_c) => {
return ff_compiler_Resolver.Resolver(ff_core_Map.Map_addAll(self_.variables_, functionMap_, ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), _c.variants_, _c.types_, _c.typeLocations_, _c.asyncTypes_, _c.typeParameters_, _c.traits_, _c.state_, _c.hoverAt_)
}))(self_);
...
const e_ = term_a;
const self2_ = (((_c) => {
return ff_compiler_Resolver.Resolver(ff_core_Map.Map_add(self_.variables_, e_.name_, e_.name_, ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), _c.variants_, _c.types_, _c.typeLocations_, _c.asyncTypes_, _c.typeParameters_, _c.traits_, _c.state_, _c.hoverAt_)
}))(self_);
{
const _1 = e_;
{
...
self_.state_.hoverResultAt_ = ff_core_Option.Some(at_)
}
}));
...
const self2_ = (((_c) => {
return ff_compiler_Resolver.Resolver(ff_core_Map.Map_addAll(self_.variables_, variableMap1_, ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), _c.variants_, _c.types_, _c.typeLocations_, _c.asyncTypes_, _c.typeParameters_, _c.traits_, _c.state_, _c.hoverAt_)
}))(self_);
const guard_ = (((_c) => {
...
const self3_ = (((_c) => {
return ff_compiler_Resolver.Resolver(ff_core_Map.Map_addAll(self_.variables_, variableMap2_, ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), _c.variants_, _c.types_, _c.typeLocations_, _c.asyncTypes_, _c.typeParameters_, _c.traits_, _c.state_, _c.hoverAt_)
}))(self_);
...
{
const z_ = x_a;
return ((((("ResolverState" + "(") + ff_core_Show.ff_core_Show_Show$ff_core_Int_Int.show_(z_.nextUnificationVariableIndex_)) + ", ") + ff_core_Option.ff_core_Show_Show$ff_core_Option_Option(ff_compiler_Syntax.ff_core_Show_Show$ff_compiler_Syntax_Location).show_(z_.hoverResultAt_)) + ")")
return
}
}
},
...
{
return ((x_.nextUnificationVariableIndex_ === y_.nextUnificationVariableIndex_) && ff_core_Option.ff_core_Equal_Equal$ff_core_Option_Option(ff_compiler_Syntax.ff_core_Equal_Equal$ff_compiler_Syntax_Location).equals_(x_.hoverResultAt_, y_.hoverResultAt_))
return
}
}
},
