...
// type Resolver
export function Resolver(variables_, variableLocations_, variants_, types_, typeGenerics_, typeLocations_, asyncTypes_, typeParameters_, traits_, traitLocations_, packagePair_, moduleName_, state_, lspHook_) {
return {variables_, variableLocations_, variants_, types_, typeGenerics_, typeLocations_, asyncTypes_, typeParameters_, traits_, traitLocations_, packagePair_, moduleName_, state_, lspHook_};
}
...
{
const _1 = ff_compiler_Resolver.Resolver_resolveTerm(self_, target_.function_, topLevel_);
{
if(_1.EVariable) {
const name_ = _1.name_;
const _guard1 = (name_ === "ff:core/SourceLocation.here");
if(_guard1) {
return ff_compiler_Syntax.EVariant(at_, "ff:core/SourceLocation.SourceLocation", ff_core_List.Empty(), ff_core_Option.Some(ff_core_List.Link(ff_compiler_Syntax.Argument(at_, ff_core_Option.None(), ff_compiler_Syntax.EString(at_, (((((((((("\"" + self_.moduleName_) + ":") + at_.line_) + ":") + at_.column_) + ",") + self_.packagePair_.group_) + ",") + self_.packagePair_.name_) + "\""))), ff_core_List.Empty())))
return
}
}
}
...
return p_.first_
}), ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), _c.variants_, _c.types_, _c.typeGenerics_, _c.typeLocations_, _c.asyncTypes_, _c.typeParameters_, _c.traits_, _c.traitLocations_, _c.packagePair_, _c.moduleName_, _c.state_, _c.lspHook_)
}))(self_);
const guard_ = (((_c) => {
