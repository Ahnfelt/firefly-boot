...
if((name_.length === 0)) {
throw ff_core_Js.initializeError_(ff_compiler_Syntax.CompileError(at_, "Expected alias after \"import * as \""), new Error(), ff_compiler_Syntax.ff_core_Any_HasAnyTag$ff_compiler_Syntax_CompileError, ff_compiler_Syntax.ff_core_Show_Show$ff_compiler_Syntax_CompileError)
};
const rest3_ = ff_core_String.String_dropFirst(rest2_, name_.length);
if((!ff_core_String.String_startsWith(rest3_, " from '", 0))) {
throw ff_core_Js.initializeError_(ff_compiler_Syntax.CompileError(at_, "Expected \" from '\" after \"import * as ...\""), new Error(), ff_compiler_Syntax.ff_core_Any_HasAnyTag$ff_compiler_Syntax_CompileError, ff_compiler_Syntax.ff_core_Show_Show$ff_compiler_Syntax_CompileError)
};
...
if((url_.length === 0)) {
throw ff_core_Js.initializeError_(ff_compiler_Syntax.CompileError(at_, "Expected module name after \" from '\""), new Error(), ff_compiler_Syntax.ff_core_Any_HasAnyTag$ff_compiler_Syntax_CompileError, ff_compiler_Syntax.ff_core_Show_Show$ff_compiler_Syntax_CompileError)
};
if(ff_core_String.String_any(url_, ((_w1) => {
return (_w1 === 10)
}))) {
throw ff_core_Js.initializeError_(ff_compiler_Syntax.CompileError(at_, "Unclosed module name string"), new Error(), ff_compiler_Syntax.ff_core_Any_HasAnyTag$ff_compiler_Syntax_CompileError, ff_compiler_Syntax.ff_core_Show_Show$ff_compiler_Syntax_CompileError)
};
