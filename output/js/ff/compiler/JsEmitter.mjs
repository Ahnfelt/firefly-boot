...
export function JsEmitter_makeOutputAndSourceMap(self_, task_, fireflyFile_, fireflySource_) {
return ff_compiler_SourceMap.makeOutputAndSourceMap_(task_, fireflyFile_, fireflySource_, self_.writtenStrings_, self_.writtenSegments_, self_.writtenAnchors_, self_.writtenNames_)
}
...
export async function JsEmitter_makeOutputAndSourceMap$(self_, task_, fireflyFile_, fireflySource_, $task) {
return (await ff_compiler_SourceMap.makeOutputAndSourceMap_$(task_, fireflyFile_, fireflySource_, self_.writtenStrings_, self_.writtenSegments_, self_.writtenAnchors_, self_.writtenNames_, $task))
}
