...
export async function make_$(otherModules_) {
return ff_compiler_JsEmitter.JsEmitter(ff_core_List.List_toMap(ff_core_List.List_map(otherModules_, ((m_) => {
const moduleName_ = ((((m_.packagePair_.first_ + ":") + m_.packagePair_.second_) + "/") + ff_core_String.String_dropLast(m_.file_, 3));
return ff_core_Pair.Pair(moduleName_, m_)
})), ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), false)
...
export async function detectIfElse_$(term_) {
{
const term_a = term_
{
if(term_a.ECall) {
...
export async function invokeImmediately_$(function_) {
{
const function_a = function_
{
if(function_a.ELambda) {
...
export async function extractTypeName_$(type_) {
{
const type_a = type_
{
if(type_a.TVariable) {
...
export async function firstTypeName_$(types_) {
return ((async (_1) => {
{
if(_1.TConstructor) {
const t_ = _1
...
export async function makeDictionaryName_$(traitName_, typeName_) {
return ((ff_core_String.String_replace(ff_core_String.String_replace(ff_core_String.String_replace(traitName_, ".", "_"), ":", "_"), "/", "_") + "$") + ff_core_String.String_replace(ff_core_String.String_replace(ff_core_String.String_replace(typeName_, ".", "_"), ":", "_"), "/", "_"))
}

export async function charLiteralToNumber_$(charLiteral_) {
{
const charLiteral_a = charLiteral_
{
if(charLiteral_a == "'\\t'") {
...
export async function escapeResolved_$(word_) {
const parts_ = ff_core_Array.Array_toList(ff_core_String.String_split(ff_core_String.String_replace(ff_core_String.String_replace(word_, ":", "."), "/", "."), 46));
const initialParts_ = ff_core_List.List_dropLast(parts_, 1);
if(ff_core_List.List_isEmpty(initialParts_)) {
return ff_compiler_JsEmitter.escapeKeyword_(ff_core_List.List_expectLast(parts_))
...
export async function escapeKeyword_$(word_) {
if(ff_core_Char.Char_isAsciiLower(ff_core_String.String_expectFirst(word_))) {
return (word_ + "_")
} else {
return word_
...
export async function effectTypeIsAsync_$(effect_) {
{
const effect_a = effect_
{
if(effect_a.TConstructor) {
...
? "async "
: "");
return ((((((("(" + prefix_) + "(") + ff_core_List.List_join(escapedArguments_, ", ")) + ") => ") + "{\n") + casesString_) + "\n})")
return
}
}
{
...
const call_ = ((((((d_ + ".") + n_) + "(") + ff_core_List.List_join(ff_core_List.List_map(arguments_, ((_w1) => {
return ff_compiler_JsEmitter.JsEmitter_emitArgument(self_, _w1, async_)
})), ", ")) + ds_) + ")");
if(await_) {
return (("(await " + call_) + ")")
...
? "$"
: ""));
const call_ = ((((functionCode_ + "(") + ff_core_List.List_join(ff_core_List.List_map(arguments_, ((_w1) => {
return ff_compiler_JsEmitter.JsEmitter_emitArgument(self_, _w1, async_)
})), ", ")) + ds_) + ")");
if(await_) {
return (("(await " + call_) + ")")
...
export async function JsEmitter_emitModule$(self_, packagePair_, module_) {
const selfImport_ = ((((((((((((("import * as " + packagePair_.first_) + "_") + packagePair_.second_) + "_") + ff_core_String.String_dropLast(module_.file_, 3)) + " ") + "from \"../../") + packagePair_.first_) + "/") + packagePair_.second_) + "/") + ff_core_String.String_dropLast(module_.file_, 3)) + ".mjs\"");
const imports_ = ff_core_List.List_map(ff_core_List.List_sortBy(module_.imports_, ((i_) => {
return ff_core_Pair.Pair(i_.package_, i_.file_)
}), ff_core_Ordering.ff_core_Ordering_Order$ff_core_Pair_Pair(ff_core_Ordering.ff_core_Ordering_Order$ff_core_Pair_Pair(ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String, ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String)), ((_w1) => {
...
export async function JsEmitter_emitMain$(self_) {
return "queueMicrotask(() => main_({array_: process.argv.slice(2)}))"
}

export async function JsEmitter_emitImportDefinition$(self_, definition_) {
return ((((((((((((("import * as " + definition_.package_.first_) + "_") + definition_.package_.second_) + "_") + definition_.file_) + " ") + "from \"../../") + definition_.package_.first_) + "/") + definition_.package_.second_) + "/") + definition_.file_) + ".mjs\"")
}

export async function JsEmitter_emitLetDefinition$(self_, definition_, mutable_, async_) {
const mutability_ = (mutable_
? "let"
: "const");
const valueCode_ = ff_core_Option.Option_else(definition_.targets_.javaScript_, (() => {
...
export async function JsEmitter_emitExtendsDefinition$(self_, definition_) {
const typeName_ = ff_core_String.String_reverse(ff_core_String.String_takeWhile(ff_core_String.String_reverse(ff_compiler_JsEmitter.extractTypeName_(definition_.type_)), ((_w1) => {
return (_w1 != 46)
})));
const methods_ = ff_core_List.List_map(definition_.methods_, ((method_) => {
...
export async function JsEmitter_emitInstanceDefinition$(self_, definition_) {
const name_ = ff_compiler_JsEmitter.makeDictionaryName_(definition_.traitName_, ff_compiler_JsEmitter.firstTypeName_(definition_.typeArguments_));
const methods_ = ff_core_List.List_map(ff_core_List.List_map(definition_.methods_, ((_w1) => {
return ff_compiler_JsEmitter.JsEmitter_emitFunctionDefinition(self_, _w1, false, "")
})), ((_w1) => {
...
export async function JsEmitter_emitFunctionDefinition$(self_, definition_, async_, suffix_ = "") {
const signature_ = ff_compiler_JsEmitter.JsEmitter_emitSignature(self_, definition_.signature_, async_, suffix_);
const target_ = (async_
? definition_.targets_.javaScriptAsync_
: definition_.targets_.javaScript_);
...
export async function JsEmitter_emitTailCall$(self_, body_) {
const outerTailCallUsed_ = self_.tailCallUsed_;
self_.tailCallUsed_ = false;
...
export async function JsEmitter_emitSignature$(self_, signature_, async_, suffix_ = "") {
const parameterStrings_ = ff_core_List.List_map(signature_.parameters_, ((_w1) => {
return ff_compiler_JsEmitter.JsEmitter_emitParameter(self_, _w1, async_)
}));
const dictionaryStrings_ = ff_core_List.List_map(signature_.constraints_, ((c_) => {
...
export async function JsEmitter_emitParameter$(self_, parameter_, async_) {
const defaultValue_ = ff_core_Option.Option_else(ff_core_Option.Option_map(parameter_.default_, ((_w1) => {
return (" = " + ff_compiler_JsEmitter.JsEmitter_emitTerm(self_, _w1, async_))
})), (() => {
return ""
...
export async function JsEmitter_emitTypeDefinition$(self_, definition_) {
if(definition_.newtype_) {
return ("// newtype " + definition_.name_)
} else {
return ((("// type " + definition_.name_) + "\n") + ff_core_List.List_join(ff_core_List.List_map(definition_.variants_, ((_w1) => {
...
export async function JsEmitter_emitVariantDefinition$(self_, typeDefinition_, definition_) {
const allFields_ = ff_core_List.List_addAll(typeDefinition_.commonFields_, definition_.fields_);
const fields_ = ff_core_List.List_join(ff_core_List.List_map(allFields_, ((_w1) => {
return ff_compiler_JsEmitter.escapeKeyword_(_w1.name_)
})), ", ");
...
export async function JsEmitter_emitTerm$(self_, term_, async_) {
{
const _1 = term_
{
if(_1.EString) {
...
export async function JsEmitter_emitDictionary$(self_, d_) {
const m_ = ((d_.moduleName_ != "")
? (((ff_core_String.String_replace(d_.packageName_, ":", "_") + "_") + ff_core_String.String_replace(d_.moduleName_, "/", "_")) + ".")
: "");
const c_ = (m_ + ff_compiler_JsEmitter.makeDictionaryName_(d_.traitName_, d_.typeName_));
...
export async function JsEmitter_emitStatements$(self_, term_, last_, async_) {
{
const _1 = term_
{
if(_1.EFunctions) {
...
export async function JsEmitter_emitCase$(self_, arguments_, matchCase_, last_, async_) {
{
const _1 = ff_core_Pair.Pair(matchCase_.patterns_, matchCase_.guards_)
{
if(_1.first_.Link) {
const p_ = _1.first_.head_
const ps_ = _1.first_.tail_
return ff_compiler_JsEmitter.JsEmitter_emitPattern(self_, ff_core_List.List_expect(arguments_, 0), p_, ff_core_List.List_dropFirst(arguments_, 1), ((async (_c) => {
return ff_compiler_Syntax.MatchCase(_c.at_, ps_, _c.guards_, _c.body_)
}))(matchCase_), last_, async_)
return
}
...
export async function JsEmitter_emitPattern$(self_, argument_, pattern_, arguments_, matchCase_, last_, async_) {
{
const _1 = pattern_
{
if(_1.PString) {
...
export async function JsEmitter_emitList$(self_, items_, async_) {
{
const _1 = items_
{
if(_1.Empty) {
...
export async function JsEmitter_processVariantCase$(self_, name_, argument_) {
const variantNameUnqualified_ = ff_core_String.String_reverse(ff_core_String.String_takeWhile(ff_core_String.String_reverse(name_), ((_w1) => {
return (_w1 != 46)
})));
const variantName_ = ff_compiler_JsEmitter.escapeKeyword_(variantNameUnqualified_);
...
export async function JsEmitter_processVariant$(self_, name_) {
const variantNameUnqualified_ = ff_core_String.String_reverse(ff_core_String.String_takeWhile(ff_core_String.String_reverse(name_), ((_w1) => {
return (_w1 != 46)
})));
const variantName_ = ff_compiler_JsEmitter.escapeKeyword_(variantNameUnqualified_);
...
export async function JsEmitter_emitArgument$(self_, argument_, async_) {
return ff_compiler_JsEmitter.JsEmitter_emitTerm(self_, argument_.value_, async_)
}
