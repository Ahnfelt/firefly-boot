...
export function logCallEffect_(at_, effect_) {
{
const at_a = at_
...
if(effect_a.name_ == "Q$") {
ff_core_Log.debug_(("Async call " + ff_compiler_Syntax.Location_show(at_)))
return
}
}
}
...
ff_compiler_JsEmitter.logCallEffect_(at_, effect_)
