...
// type Compiler
export function Compiler(emitTarget_, task_, jsOutputPath_, packagePaths_, singleFilePackages_, virtualFiles_, cache_, lspHook_, phaseDurationDelta_, phaseDurations_) {
return {emitTarget_, task_, jsOutputPath_, packagePaths_, singleFilePackages_, virtualFiles_, cache_, lspHook_, phaseDurationDelta_, phaseDurations_};
}
...
export function new_(emitTarget_, task_, jsOutputPath_, resolvedDependencies_, virtualFiles_, cache_, lspHook_) {
return ff_compiler_Compiler.Compiler(emitTarget_, task_, jsOutputPath_, resolvedDependencies_.packagePaths_, resolvedDependencies_.singleFilePackages_, virtualFiles_, cache_, lspHook_, 0.0, ff_core_List.List_toArray([]))
}
...
export async function new_$(emitTarget_, task_, jsOutputPath_, resolvedDependencies_, virtualFiles_, cache_, lspHook_, $task) {
return ff_compiler_Compiler.Compiler(emitTarget_, task_, jsOutputPath_, resolvedDependencies_.packagePaths_, resolvedDependencies_.singleFilePackages_, virtualFiles_, cache_, lspHook_, 0.0, ff_core_List.List_toArray([]))
}
...
const emitter_ = ff_compiler_JsEmitter.new_(allModules_, self_.emitTarget_, isMainModule_, moduleKey_);
