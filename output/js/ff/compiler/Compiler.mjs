...
export async function make_$(files_, time_, jsOutputPath_, packagePaths_, $signal) {
return ff_compiler_Compiler.Compiler(files_, time_, jsOutputPath_, packagePaths_, ff_core_Map.empty_(), ff_core_Map.empty_(), ff_core_Map.empty_(), ff_core_Set.empty_(), ff_core_List.Empty(), 0.0)
}
...
export async function Compiler_measure$(self_, phase_, packageName_, moduleName_, body_, $signal) {
const start_ = (ff_core_TimeSystem.TimeSystem_elapsed(self_.time_) - self_.phaseDurationDelta_);
...
const packagePath_ = ff_core_Map.Map_expect(self_.packagePaths_, packageName_, ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String);
const file_ = (moduleName_ + ".ff");
const code_ = (await ff_core_FileSystem.FileSystem_readText$(self_.files_, ((packagePath_ + "/") + file_), $signal));
const tokens_ = ff_compiler_Tokenizer.tokenize_(file_, code_);
const module_ = ff_compiler_Parser.Parser_parseModule(ff_compiler_Parser.make_(packagePair_, file_, tokens_));
...
export async function Compiler_resolve$(self_, packageName_, moduleName_, $signal) {
return (await ff_core_Option.Option_else$(ff_core_Map.Map_get(self_.resolvedModules_, ((packageName_ + ":") + moduleName_), ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), (async ($signal) => {
return (await ff_compiler_Compiler.Compiler_measure$(self_, "Resolve", packageName_, moduleName_, (async ($signal) => {
const module_ = (await ff_compiler_Compiler.Compiler_parse$(self_, packageName_, moduleName_, $signal));
const otherModules_ = (await ff_compiler_Compiler.Compiler_imports$(self_, packageName_, module_, $signal));
const result_ = ff_compiler_Resolver.Resolver_resolveModule(ff_compiler_Resolver.make_(), module_, otherModules_);
self_.resolvedModules_ = ff_core_Map.Map_add(self_.resolvedModules_, ((packageName_ + ":") + moduleName_), result_, ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String);
return result_
}), $signal))
...
export async function Compiler_infer$(self_, packageName_, moduleName_, $signal) {
return (await ff_core_Option.Option_else$(ff_core_Map.Map_get(self_.inferredModules_, ((packageName_ + ":") + moduleName_), ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String), (async ($signal) => {
return (await ff_compiler_Compiler.Compiler_measure$(self_, "Infer", packageName_, moduleName_, (async ($signal) => {
const module_ = (await ff_compiler_Compiler.Compiler_resolve$(self_, packageName_, moduleName_, $signal));
const otherModules_ = (await ff_core_List.List_map$((await ff_compiler_Compiler.Compiler_imports$(self_, packageName_, module_, $signal)), (async (i_, $signal) => {
const newPackageName_ = ((i_.packagePair_.first_ + ":") + i_.packagePair_.second_);
return (await ff_compiler_Compiler.Compiler_resolve$(self_, newPackageName_, (await ff_core_FileSystem.FileSystem_prefixName$(self_.files_, i_.file_, $signal)), $signal))
}), $signal));
const inferredModule_ = ff_compiler_Inference.Inference_inferModule(ff_compiler_Inference.make_(ff_core_List.Link(module_, otherModules_)), module_, otherModules_);
const result_ = ff_compiler_Dictionaries.Dictionaries_processModule(ff_compiler_Dictionaries.make_(ff_core_List.Link(module_, otherModules_)), inferredModule_, otherModules_);
self_.inferredModules_ = ff_core_Map.Map_add(self_.inferredModules_, ((packageName_ + ":") + moduleName_), result_, ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String);
...
export async function Compiler_emit$(self_, packageName_, moduleName_, $signal) {
if(ff_core_Set.Set_contains(self_.emittedModules_, ((packageName_ + ":") + moduleName_), ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String)) {

} else {
(await ff_compiler_Compiler.Compiler_measure$(self_, "Emit", packageName_, moduleName_, (async ($signal) => {
self_.emittedModules_ = ff_core_Set.Set_add(self_.emittedModules_, ((packageName_ + ":") + moduleName_), ff_core_Ordering.ff_core_Ordering_Order$ff_core_String_String);
const module_ = (await ff_compiler_Compiler.Compiler_infer$(self_, packageName_, moduleName_, $signal));
const otherModules_ = (await ff_core_List.List_map$((await ff_compiler_Compiler.Compiler_imports$(self_, packageName_, module_, $signal)), (async (i_, $signal) => {
const newPackageName_ = ((i_.packagePair_.first_ + ":") + i_.packagePair_.second_);
const newModuleName_ = (await ff_core_FileSystem.FileSystem_prefixName$(self_.files_, i_.file_, $signal));
...
const jsPath_ = ((self_.jsOutputPath_ + "/") + ff_core_String.String_replace(packageName_, ":", "/"));
const jsFile_ = (((jsPath_ + "/") + moduleName_) + ".mjs");
(await ff_core_FileSystem.FileSystem_createDirectories$(self_.files_, jsPath_, $signal));
return (await ff_core_FileSystem.FileSystem_writeText$(self_.files_, jsFile_, js_, $signal))
}), $signal))
}
}
