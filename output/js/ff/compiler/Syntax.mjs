...
// type CompletionInfo
export function CompletionInfo(label_, snippet_, member_, type_, documentation_, preselect_) {
return {label_, snippet_, member_, type_, documentation_, preselect_};
}
...
{
return ((x_.label_ === y_.label_) && ((x_.snippet_ === y_.snippet_) && ((x_.member_ === y_.member_) && (ff_compiler_Syntax.ff_core_Equal_Equal$ff_compiler_Syntax_Type.equals_(x_.type_, y_.type_) && ((x_.documentation_ === y_.documentation_) && (x_.preselect_ === y_.preselect_))))))
return
}
}
},
...
const preselectOrdering_ = ff_core_Ordering.ff_core_Ordering_Order$ff_core_Bool_Bool.compare_(x_.preselect_, y_.preselect_);
if((preselectOrdering_ !== ff_core_Ordering.OrderingSame())) {
return preselectOrdering_
} else {
return ff_core_Ordering.OrderingSame()
}
}
...
ff_core_Serializable.ff_core_Serializable_Serializable$ff_core_Bool_Bool.serializeUsing_(serialization_, value_.preselect_)
return
}
}
},
