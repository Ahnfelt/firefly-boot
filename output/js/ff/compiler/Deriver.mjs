...
const showInstances_ = ff_compiler_Deriver.Deriver_makeShowInstances(self_, modulePrefix_, coreWhitelist_, module_);
const orderingInstances_ = ff_compiler_Deriver.Deriver_makeOrderingInstances(self_, modulePrefix_, coreWhitelist_, module_);
{
const _1 = module_;
{
const _c = _1;
return ff_compiler_Syntax.Module(_c.file_, _c.packagePair_, _c.imports_, _c.types_, _c.traits_, ff_core_List.List_addAll(module_.instances_, ff_core_List.List_addAll(showInstances_, orderingInstances_)), _c.extends_, _c.lets_, _c.functions_)
return
}
}
}

export function Deriver_makeShowInstances(self_, modulePrefix_, coreWhitelist_, module_) {
...
export function Deriver_makeOrderingInstances(self_, modulePrefix_, coreWhitelist_, module_) {
...
export async function Deriver_makeShowInstances$(self_, modulePrefix_, coreWhitelist_, module_, $c) {
const missingInstance_ = ff_compiler_Deriver.Deriver_findTypesThatNeedInstances(self_, "ff:core/Show.Show", modulePrefix_, coreWhitelist_, module_);
return ff_core_List.List_map(missingInstance_, ((_w1) => {
return ff_compiler_Deriver.Deriver_makeShowInstance(self_, modulePrefix_, _w1)
}))
...
export async function Deriver_makeOrderingInstances$(self_, modulePrefix_, coreWhitelist_, module_, $c) {
const missingInstance_ = ff_compiler_Deriver.Deriver_findTypesThatNeedInstances(self_, "ff:core/Ordering.Order", modulePrefix_, coreWhitelist_, module_);
return ff_core_List.List_map(missingInstance_, ((_w1) => {
return ff_compiler_Deriver.Deriver_makeOrderingInstance(self_, modulePrefix_, _w1)
}))
