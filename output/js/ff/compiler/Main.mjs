...
export function main_(system_) {
    ff_core_Set.Set_each(ff_core_List.List_toSet(ff_core_List.Link(ff_compiler_Unification.InstanceKey("A", "C"), ff_core_List.Link(ff_compiler_Unification.InstanceKey("A", "B"), ff_core_List.Link(ff_compiler_Unification.InstanceKey("B", "C"), ff_core_List.Link(ff_compiler_Unification.InstanceKey("B", "A"), ff_core_List.Empty())))), ff_compiler_Unification.ff_core_Ordering_Order$ff_compiler_Unification_InstanceKey), ((k_) => {
        ff_core_Log.debug_(k_)
