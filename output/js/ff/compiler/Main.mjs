...
{
const _exception = ff_compiler_Syntax.CompileError(at_, "This module does not contain a 'nodeMain' function"); 
...
{
const _exception = ff_compiler_Syntax.CompileErrors(ff_core_List.List_distinct(errors_, ff_compiler_Syntax.ff_core_Ordering_Order$ff_compiler_Syntax_CompileError)); 
...
{
{
const _exception = ff_compiler_Main.CommandLineError(("You must specify a Firefly file (.ff) as first argument to run." + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
}
...
if(_1.length >= 2) {
{
const _exception = ff_compiler_Main.CommandLineError(("You must only specify a single argument to browser." + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
{
{
const _exception = ff_compiler_Main.CommandLineError(("You must specify a Firefly file (.ff) as the argument to browser." + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
...
if(_1.length >= 2) {
{
const _exception = ff_compiler_Main.CommandLineError(("You must only specify a single argument to build." + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
{
{
const _exception = ff_compiler_Main.CommandLineError(("You must specify a Firefly file (.ff) as the argument to build." + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
...
if(_1.length >= 2) {
{
const _exception = ff_compiler_Main.CommandLineError(("You must only specify a single argument to check." + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
{
{
const _exception = ff_compiler_Main.CommandLineError(("You must specify a Firefly file (.ff) or directory as the argument to check." + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
...
{
{
const _exception = ff_compiler_Main.CommandLineError(("You must specify a output file (.tsv) and 1+ Firefly files (.ff) to symbols." + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
...
{
const _exception = ff_compiler_Main.CommandLineError(("bootstrap takes no arguments" + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
...
{
const _exception = ff_compiler_Main.CommandLineError(("You must specify a command or a main file to run." + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
...
{
const _exception = ff_compiler_Main.CommandLineError(((("Unknown command '" + s_) + "'") + ff_compiler_Main.usageString_)); 
throw Object.assign(new Error(ff_compiler_Main.ff_core_Show_Show$ff_compiler_Main_CommandLineError.show_(_exception)), {ffException: ff_core_Any.toAny_(_exception, ff_compiler_Main.ff_core_Any_HasAnyTag$ff_compiler_Main_CommandLineError)})
}
return
}
