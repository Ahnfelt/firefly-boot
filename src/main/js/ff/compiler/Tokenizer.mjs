...
ff_core_Core.while_((() => {
return ((i_ < ff_core_String.String_size(code_)) && (((ff_core_String.String_expect(code_, i_) == 32) || (ff_core_String.String_expect(code_, i_) == 9)) || (ff_core_String.String_expect(code_, i_) == 13)))
}), (() => {
i_ += 1;
return (void 0)
}));
...
return ff_core_Option.Option_elseIf(ff_core_Option.Option_elseIf(ff_core_Option.Option_elseIf(ff_core_Option.Option_elseIf(ff_core_Option.Option_elseIf(ff_core_Option.Option_elseIf(ff_core_Option.Option_elseIf(ff_core_Option.Option_elseIf(ff_core_Option.Option_elseIf(ff_core_Option.Option_elseIf(ff_core_Core.if_((ff_core_String.String_expect(code_, i_) == 10), (() => {
i_ += 1;
line_ += 1;
lineOffset_ = i_;
(void 0);
...
i_ += 2;
ff_core_Core.while_((() => {
return ((i_ < ff_core_String.String_size(code_)) && (ff_core_String.String_expect(code_, i_) != 10))
}), (() => {
i_ += 1;
(void 0);
(void 0);
...
i_ += 2;
ff_core_Core.while_((() => {
return ((i_ < ff_core_String.String_size(code_)) && ((ff_core_String.String_expect(code_, i_) != 42) || (ff_core_String.String_expect(code_, (i_ + 1)) != 47)))
}), (() => {
...
ff_core_Core.while_((() => {
return ((i_ < ff_core_String.String_size(code_)) && (multiLine_ || (ff_core_String.String_expect(code_, i_) != endSign_)))
}), (() => {
ff_core_Core.if_((ff_core_String.String_expect(code_, i_) == 10), (() => {
...
i_ += 1;
return emitToken_(ff_core_Option.Option_else(ff_core_Core.if_((endSign_ == 34), (() => {
...
i_ += 1;
ff_core_Core.while_((() => {
return ((i_ < ff_core_String.String_size(code_)) && ((((ff_core_String.String_expect(code_, i_) >= 97) && (ff_core_String.String_expect(code_, i_) <= 122)) || ((ff_core_String.String_expect(code_, i_) >= 65) && (ff_core_String.String_expect(code_, i_) <= 90))) || ((ff_core_String.String_expect(code_, i_) >= 48) && (ff_core_String.String_expect(code_, i_) <= 57))))
}), (() => {
i_ += 1;
(void 0);
(void 0);
...
return ff_core_Option.Option_else(ff_core_Core.if_(((kind_ == ff_compiler_Token.LUpper()) && (ff_core_String.String_expect(code_, i_) == 46)), (() => {
i_ += 1;
...
let exponent_ = false;
ff_core_Core.while_((() => {
return ((i_ < ff_core_String.String_size(code_)) && ((ff_core_String.String_expect(code_, i_) >= 48) && (ff_core_String.String_expect(code_, i_) <= 57)))
}), (() => {
i_ += 1;
...
return emitToken_(ff_core_Option.Option_else(ff_core_Core.if_((dot_ || exponent_), (() => {
...
i_ += 1;
ff_core_Core.while_((() => {
return ((i_ < ff_core_String.String_size(code_)) && ff_core_Set.Set_contains(operatorCharacters_, ff_core_String.String_expect(code_, i_)))
}), (() => {
i_ += 1;
(void 0);
(void 0);
...
return emitToken_(o_, start_, i_);
(void 0);
(void 0);
(void 0);
return (void 0)
...
return ff_core_Core.panic_(((((((("Unexpected character: " + ff_core_Core.magicShow_(ff_core_String.String_expect(code_, i_))) + " in ") + file_) + " at line ") + line_) + ", column ") + column_));
return (void 0)
}));
return (void 0)
}));
