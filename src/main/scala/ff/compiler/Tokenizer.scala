...
ff.core.List_.List_map[ff.core.Int_.Int, ff.core.Unit_.Unit](self_ = ff.core.Int_.Int_until(self_ = 0, exclusive_ = ff.core.String_.String_size(self_ = operatorCharactersString_)), body_ = {(j_) =>
...
ff.core.Core_.if_[ff.core.Option_.Option[ff.core.Unit_.Unit]](condition_ = (!ff.core.ArrayBuilder_.ArrayBuilder_isEmpty[ff.compiler.Token_.Token](self_ = tokens_)), body_ = {() =>
...
ff.core.ArrayBuilder_.ArrayBuilder_modify[ff.compiler.Token_.Token](self_ = tokens_, index_ = (ff.core.ArrayBuilder_.ArrayBuilder_size[ff.compiler.Token_.Token](self_ = tokens_) - 1), body_ = {(_w1) =>
pipe_dot(_w1)({(_c) =>
...
ff.core.Core_.while_(condition_ = {() =>
((i_ < ff.core.String_.String_size(self_ = code_)) && (((ff.core.String_.String_expect(self_ = code_, index_ = i_) == ' ') || (ff.core.String_.String_expect(self_ = code_, index_ = i_) == '\t')) || (ff.core.String_.String_expect(self_ = code_, index_ = i_) == '\r')))
}, body_ = {() =>
i_ += 1;
ff.core.Unit_.Unit()
});
...
i_ += 2;
ff.core.Core_.while_(condition_ = {() =>
((i_ < ff.core.String_.String_size(self_ = code_)) && (ff.core.String_.String_expect(self_ = code_, index_ = i_) != '\n'))
}, body_ = {() =>
i_ += 1;
ff.core.Unit_.Unit();
ff.core.Unit_.Unit();
...
i_ += 2;
ff.core.Core_.while_(condition_ = {() =>
((i_ < ff.core.String_.String_size(self_ = code_)) && ((ff.core.String_.String_expect(self_ = code_, index_ = i_) != '*') || (ff.core.String_.String_expect(self_ = code_, index_ = (i_ + 1)) != '/')))
}, body_ = {() =>
ff.core.Core_.if_[ff.core.Nothing_.Nothing](condition_ = (i_ >= ff.core.String_.String_size(self_ = code_)), body_ = {() =>
...
var multiLine_ : ff.core.Bool_.Bool = (((((i_ + 2) < ff.core.String_.String_size(self_ = code_)) && (ff.core.String_.String_expect(self_ = code_, index_ = i_) == '"')) && (ff.core.String_.String_expect(self_ = code_, index_ = (i_ + 1)) == '"')) && (ff.core.String_.String_expect(self_ = code_, index_ = (i_ + 2)) == '"'));
...
ff.core.Core_.while_(condition_ = {() =>
((i_ < ff.core.String_.String_size(self_ = code_)) && (multiLine_ || (ff.core.String_.String_expect(self_ = code_, index_ = i_) != endSign_)))
}, body_ = {() =>
ff.core.Core_.if_[ff.core.Unit_.Unit](condition_ = (ff.core.String_.String_expect(self_ = code_, index_ = i_) == '\n'), body_ = {() =>
...
ff.core.Option_.Option_else(self_ = ff.core.Core_.if_[ff.core.Unit_.Unit](condition_ = (((((multiLine_ && ((i_ + 2) < ff.core.String_.String_size(self_ = code_))) && (((i_ + 3) >= ff.core.String_.String_size(self_ = code_)) || (ff.core.String_.String_expect(self_ = code_, index_ = (i_ + 3)) != '"'))) && (ff.core.String_.String_expect(self_ = code_, index_ = i_) == '"')) && (ff.core.String_.String_expect(self_ = code_, index_ = (i_ + 1)) == '"')) && (ff.core.String_.String_expect(self_ = code_, index_ = (i_ + 2)) == '"')), body_ = {() =>
...
i_ += 1;
ff.core.Core_.while_(condition_ = {() =>
((i_ < ff.core.String_.String_size(self_ = code_)) && ((((ff.core.String_.String_expect(self_ = code_, index_ = i_) >= 'a') && (ff.core.String_.String_expect(self_ = code_, index_ = i_) <= 'z')) || ((ff.core.String_.String_expect(self_ = code_, index_ = i_) >= 'A') && (ff.core.String_.String_expect(self_ = code_, index_ = i_) <= 'Z'))) || ((ff.core.String_.String_expect(self_ = code_, index_ = i_) >= '0') && (ff.core.String_.String_expect(self_ = code_, index_ = i_) <= '9'))))
}, body_ = {() =>
i_ += 1;
ff.core.Unit_.Unit();
ff.core.Unit_.Unit();
...
ff.core.Core_.while_(condition_ = {() =>
((i_ < ff.core.String_.String_size(self_ = code_)) && ((ff.core.String_.String_expect(self_ = code_, index_ = i_) >= '0') && (ff.core.String_.String_expect(self_ = code_, index_ = i_) <= '9')))
}, body_ = {() =>
i_ += 1;
...
ff.core.Core_.if_[ff.core.Unit_.Unit](condition_ = (((((((i_ + 1) < ff.core.String_.String_size(self_ = code_)) && (ff.core.String_.String_expect(self_ = code_, index_ = i_) == '.')) && (ff.core.String_.String_expect(self_ = code_, index_ = (i_ + 1)) >= '0')) && (ff.core.String_.String_expect(self_ = code_, index_ = (i_ + 1)) <= '9')) && (!dot_)) && (!exponent_)), body_ = {() =>
i_ += 1;
dot_ = ff.core.Bool_.True();
ff.core.Unit_.Unit();
ff.core.Unit_.Unit();
...
i_ += 1;
ff.core.Core_.while_(condition_ = {() =>
((i_ < ff.core.String_.String_size(self_ = code_)) && ff.core.Set_.Set_contains[ff.core.Char_.Char](self_ = operatorCharacters_, value_ = ff.core.String_.String_expect(self_ = code_, index_ = i_)))
}, body_ = {() =>
i_ += 1;
ff.core.Unit_.Unit();
ff.core.Unit_.Unit();
